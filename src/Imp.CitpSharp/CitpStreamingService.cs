...
namespace Imp.CitpSharp
{
	...
	//	public void AddStreamRequest(MsexVersion? peerMsexVersion, RequestStreamPacket requestPacket)
	//	{
	...
	//				var packet = new StreamFramePacket
	//				{
	...
	//					packet.FragmentInfo = new StreamFramePacket.FragmentPreamble()
	//					{
	...
	//		public void AddRequestFormat(MsexVersion peerMsexVersion, RequestStreamPacket packet)
	//		{
