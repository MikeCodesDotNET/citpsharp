...
namespace Imp.CitpSharp.Packets.Msex
{
	internal class StreamFramePacket : MsexPacket
	{
		...
		public StreamFramePacket(MsexVersion version, Guid mediaServerUuid, ushort sourceId, MsexImageFormat frameFormat,
			ushort frameWidth, ushort frameHeight, byte[] frameBuffer, [CanBeNull] FragmentPreamble fragmentInfo = null,
		...
		public class FragmentPreamble : IEquatable<FragmentPreamble>
		{
			...
			public bool Equals([CanBeNull] FragmentPreamble other)
			{
				...
				if (ReferenceEquals(this, other))
					return true;
				return FrameIndex == other.FrameIndex && FragmentCount == other.FragmentCount
			...
			public override bool Equals([CanBeNull] object obj)
			{
				...
				if (ReferenceEquals(this, obj))
					return true;
				return obj.GetType() == GetType() && Equals((FragmentPreamble)obj);
			}
